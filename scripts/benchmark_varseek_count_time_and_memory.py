...
k_small = 31
vk_ref_k_small_index_path = ""  #!!! update
vk_ref_k_small_t2g_path = ""  #!!! update
...
for number_of_reads in number_of_reads_list:
    ...
    if "varseek" in tools_to_benchmark:
        print(f"varseek k={k_small}, {number_of_reads} reads")
        ...
        argparse_flags = f"--index {vk_ref_k_small_index_path} --t2g {vk_ref_k_small_t2g_path} --out {vk_count_out_tmp} -k {k_small} --kb_count_reference_genome_out_dir {kb_count_reference_genome_out_dir} --disable_summarize {fastq_output_path}"
        _ = report_time_and_memory_of_script(vk_count_script_path, output_file = output_file, argparse_flags = argparse_flags)
