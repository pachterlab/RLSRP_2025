...
# Paths
parser.add_argument("--synthetic_read_fastq1", help="Path to synthetic read FASTQ1")
parser.add_argument("--synthetic_read_fastq2", help="Path to synthetic read FASTQ2")
...
synthetic_read_fastq1 = args.synthetic_read_fastq1
...
star_align_command = [
    ...
    "--runThreadN", str(threads),
    "--genomeDir", star_genome_dir,
    "--readFilesIn", synthetic_read_fastq1, synthetic_read_fastq2,
    "--sjdbOverhang", str(read_length_minus_one),
...
if synthetic_read_fastq1.endswith(".gz"):
...
fastq_to_sam_command = [
    ...
    "-F1", synthetic_read_fastq1,
    "-F2", synthetic_read_fastq2,
    "-OUTPUT", unmapped_bam,
    "-READ_GROUP_NAME", "rg1",
    "-SAMPLE_NAME", "sample1",
    "-LIBRARY_NAME", "lib1",
